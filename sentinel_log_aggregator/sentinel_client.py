...
from .models import WorkspaceConfig, KQLQueryDefinition
from .security_utils import (
    validate_kql_query, validate_workspace_id, sanitize_log_output,
    generate_correlation_id, SecureLogger
)
        ...
        try:
            ...
            if response.tables:
                for table in response.tables:
                    if hasattr(table, 'columns') and hasattr(table, 'rows') and table.columns and table.rows:
        ...
        *,
        ...
        try:
            ...
            response = await self._logs_ingestion_client_instance.upload(
                rule_id=self._options.dcr_rule_id,
                stream_name=stream_name,
