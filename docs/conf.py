...
latex_documents = [
    (master_doc, 'SentinelLogAggregator.tex', 'Microsoft Sentinel Log Aggregator Documentation',
     'Microsoft Sentinel Team', 'manual'),
]
...
man_pages = [
    (master_doc, 'sentinel-log-aggregator', 'Microsoft Sentinel Log Aggregator Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'SentinelLogAggregator', 'Microsoft Sentinel Log Aggregator Documentation',
     author, 'SentinelLogAggregator', 'Microsoft Sentinel Log Aggregator for multi-workspace log aggregation.',
     'Miscellaneous'),
]
