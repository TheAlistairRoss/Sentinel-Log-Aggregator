...
class TestQueryEnginePerformance:
    ...
    def mock_azure_client(self):
        ...
        client.query_workspace.return_value = MagicMock()
        client.upload_logs.return_value = MagicMock()
    ...
    def test_memory_usage_large_datasets(self, query_engine):
        ...
        # Skip data transformation - architectural violation removed
...
class TestWorkspaceConfigValidation:
    ...
    def test_invalid_query_name(self):
        """Test invalid query name in queries list."""
        config_data = {
            'resource_id': '/subscriptions/12345678-1234-1234-1234-123456789abc/resourcegroups/test-rg/providers/microsoft.operationalinsights/workspaces/test-workspace',
            'customer_id': '11111111-1111-1111-1111-111111111111',
            'queries_list': ['invalid_query_name']
        }
        
        with pytest.raises(ValidationError) as exc_info:
            WorkspaceConfigModel(**config_data)
        
        assert 'invalid_query_name' in str(exc_info.value).lower() or 'query' in str(exc_info.value).lower()
...
class TestQueryDefinitionValidation:
    ...
    def test_invalid_query_name(self):
        ...
        query_data = {
            ...
            'destination_stream': 'Custom-Test_TestQuery_CL',
            'stream_name': 'stream_invalid_name',
            'query': 'SecurityIncident | take 10'
        }
...
class TestWorkspaceManager:
    ...
    def test_for_query(self, sample_workspaces):
