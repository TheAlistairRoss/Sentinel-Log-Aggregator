...
class TestSentinelAggregatorError:
    ...
    def test_initialization_with_error_code(self):
        ...
        error = SentinelAggregatorError("Test error message", error_code="TEST_ERROR_001")
    ...
    def test_initialization_with_error_details(self):
        ...
        error = SentinelAggregatorError("Test error message", error_details=details)
    ...
    def test_initialization_with_all_parameters(self):
        ...
        error = SentinelAggregatorError(
            "Test error message", error_code="FULL_ERROR_001", error_details=details
        )
    ...
    def test_initialization_with_kwargs(self):
        ...
        error = SentinelAggregatorError("Test message", error_code="TEST_001")
    ...
    def test_error_details_defaults_to_empty_dict(self):
        ...
        error = SentinelAggregatorError("Test message", error_details=None)
...
class TestDataIngestionError:
    ...
    def test_initialization_with_zero_record_count(self):
        ...
        error = DataIngestionError("No records to ingest", record_count=0)
...
class TestConfigurationError:
    ...
    def test_initialization_with_config_key(self):
        ...
        error = ConfigurationError(
            "Missing required configuration", config_key=config_key, error_code="CONFIG_MISSING"
        )
...
class TestBatchOperationError:
    ...
    def test_initialization_with_zero_counts(self):
        ...
        error = BatchOperationError(
            "No operations completed", failed_operations=0, total_operations=0
        )
...
class TestCredentialValidationError:
    ...
    def test_initialization_with_credential_info(self):
        ...
        error = CredentialValidationError(
            "Failed to validate credentials", credential_type=credential_type, scope=scope
        )
...
class TestErrorMessageFormatting:
    ...
    def test_error_details_formatting(self):
        ...
        error = DataIngestionError("Ingestion failed", error_details=details)
