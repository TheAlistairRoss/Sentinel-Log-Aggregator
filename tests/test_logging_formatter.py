...
class TestLogEventType:
    ...
    def test_all_event_types_exist(self):
        ...
        expected_types = [
            "BATCH_START", "BATCH_END", "QUERY_START", "QUERY_END",
            "UPLOAD_START", "UPLOAD_END", "WORKSPACE_CONFIG",
            "ERROR", "PROGRESS", "SUMMARY"
        ]
...
class TestSentinelLogFormatter:
    ...
    def test_format_batch_end(self):
        ...
        expected = ("[BATCH_END] Job: test-job-123 | "
                   "Queries: 8/10 | "
                   "Uploads: 7/8 | "
    ...
    def test_format_batch_end_with_missing_values(self):
        ...
        expected = ("[BATCH_END] Job: test-job-456 | "
                   "Queries: 0/0 | "
                   "Uploads: 0/0 | "
    ...
    def test_format_query_start(self):
        ...
        expected = ("[QUERY_START] Job: test-job-789 | "
    ...
    def test_format_query_end_success(self):
        ...
        expected = ("[QUERY_END] Job: test-job-789 | "
                   "Query: incident_summary | "
                   "Workspace: workspace-alpha | "
                   "Status: SUCCESS | "
                   "Records: 1,250 | "
    ...
    def test_format_upload_start(self):
        ...
        expected = ("[UPLOAD_START] Job: test-job-upload | "
                   "Query: alert_summary | "
    ...
    def test_format_upload_end_success(self):
        ...
        expected = ("[UPLOAD_END] Job: test-job-upload | "
                   "Query: alert_summary | "
                   "Workspace: workspace-beta | "
                   "Status: SUCCESS | "
                   "Uploaded: 750 | "
    ...
    def test_format_progress_with_additional_info(self):
        ...
        expected = ("[PROGRESS] Job: progress-job-456 | "
                   "Completed: 3/8 (37.5%) | "
    ...
    def test_format_workspace_config_valid(self):
        ...
        expected = ("[WORKSPACE_CONFIG] Status: VALID | "
                   "Workspaces: 15 | Reports: 8 | Subscriptions: 3")
        assert result == expected
    ...
    def test_format_workspace_config_with_errors(self):
        ...
        expected = ("[WORKSPACE_CONFIG] Status: ERRORS (3) | "
    ...
    def test_format_config_validation_valid(self):
        ...
        expected = ("[CONFIG_VALIDATION] Component: AzureCredentials | "
                   "Status: VALID | "
                   "Details: All required environment variables present")
        assert result == expected
    ...
    def test_format_config_validation_invalid(self):
        ...
        expected = ("[CONFIG_VALIDATION] Component: WorkspaceConfig | "
                   "Status: INVALID | "
                   "Details: Missing workspace_id field")
        assert result == expected
    ...
    def test_format_batch_summary(self):
        ...
        expected = ("[BATCH_SUMMARY] Job: summary-job-123 | "
                   "Workspaces: 5 | "
                   "Queries: 12 | "
                   "Duration: 245.7s | "
                   "Downloaded: 25000 | "
    ...
    def test_format_batch_summary_missing_overview(self):
        ...
        expected = ("[BATCH_SUMMARY] Job: summary-job-456 | "
                   "Workspaces: 0 | "
                   "Queries: 0 | "
                   "Duration: 0.0s | "
                   "Downloaded: 0 | "
...
class TestContextualLogger:
    ...
    def test_progress(self, contextual_logger, mock_logger):
        ...
        contextual_logger.progress(
            completed=4,
            total=10,
            additional_info="Processing data"
        )
