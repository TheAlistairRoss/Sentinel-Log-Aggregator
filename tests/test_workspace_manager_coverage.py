...
class TestWorkspaceSetCoverage:
    ...
    def diverse_workspaces(self):
        ...
        return [
            WorkspaceConfig(
                ...
                parameters={"row_level_security_tag": "prod", "environment": "production", "region": "eastus"},
            ...
            WorkspaceConfig(
                ...
                parameters={"row_level_security_tag": "dev", "environment": "development", "region": "westus"},
            ...
            WorkspaceConfig(
                ...
                parameters={"row_level_security_tag": "", "environment": "test"},  # Empty security tag
    ...
    def test_filter_by_alias_empty_string(self, diverse_workspaces):
        ...
        assert filtered.count() == 2  # ws3 has empty string, ws4 has no parameter (defaults to empty)
    ...
    def test_filter_by_parameter_none_value(self, diverse_workspaces):
        ...
        assert filtered.count() == 4  # All workspaces don't have "nonexistent" parameter    def test_has_query_empty_queries_list(self, diverse_workspaces):
    ...
    def test_display_with_logger(self, diverse_workspaces, caplog):
        ...
        assert any("ws1" in record.message for record in caplog.records), f"Expected 'ws1' in logs, got: {[r.message for r in caplog.records]}"
...
class TestWorkspaceManagerCoverage:
    ...
    def test_validate_configuration_invalid_resource_id_format(self):
        ...
        assert any("cannot extract workspace name" in error for error in errors), f"Expected workspace name extraction error, got: {errors}"
    ...
    def test_display_summary_valid_configuration(self, complex_workspaces, caplog):
        ...
        assert any("Reports configured" in record.message for record in caplog.records), f"Expected 'Reports configured' in logs, got: {[r.message for r in caplog.records]}"
...
class TestWorkspaceManagerFileOperationsCoverage:
    ...
    def test_from_file_validation_fallback(self, tmp_path):
        ...
        with patch('sentinel_log_aggregator.workspace_manager.validate_workspace_config') as mock_validate:
    ...
    def test_from_file_invalid_workspace_data_type(self, tmp_path):
        ...
        yaml_content = {
            'workspaces': "not a list"  # Should be a list
        }
