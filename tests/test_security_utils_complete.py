...
class TestSecurityUtilsComplete:
    ...
    def test_edge_case_combinations(self):
        ...
        result = sanitize_log_output(edge_data, sensitive_fields=["empty_string", "short_sensitive"])
...
class TestSecurityUtilsErrorConditions:
    ...
    def test_secure_logger_all_methods_lines_311_335(self):
        ...
        secure_logger.info("Test message", extra={"customer_id": "12345678-1234-1234-1234-123456789012"})
        mock_logger.info.assert_called_once()
        
        # Test error method (lines 321-323)
        mock_logger.reset_mock()
        secure_logger.error("Error message", extra={"workspace_id": "sensitive_workspace"}, exc_info=True)
