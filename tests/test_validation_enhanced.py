...
class TestWorkspaceConfigModelEdgeCases:
    ...
    def test_resource_id_validator_empty_string(self):
        ...
        config_data = {"resource_id": "", "customer_id": "11111111-1111-1111-1111-111111111111"}
...
class TestQueryParameterModelValidation:
    ...
    def test_validate_default_type_int_valid(self):
        ...
        param_data = {"type": "int", "default": 42, "description": "Test integer parameter"}
    ...
    def test_validate_default_type_float_valid_float(self):
        ...
        param_data = {"type": "float", "default": 42.5, "description": "Test float parameter"}
    ...
    def test_validate_default_type_bool_valid(self):
        ...
        param_data = {"type": "bool", "default": True, "description": "Test boolean parameter"}
...
class TestQueryDefinitionModelEdgeCases:
    ...
    def test_validate_query_syntax_completely_empty(self):
        ...
        assert "characters" in str(exc_info.value).lower() or "Query cannot be empty" in str(
            exc_info.value
        )
...
class TestValidationFunctions:
    ...
    def test_validate_functions_with_validation_errors(self):
        ...
        invalid_workspace_data = {
            "workspaces": [
                {"resource_id": "invalid-resource-id", "customer_id": "invalid-customer-id"}
            ]
        }
    ...
    def test_resource_id_validator_manual_trigger(self):
        ...
        for test_resource_id in test_cases:
            try:
                ...
                error_msg = str(e)
                assert (
                    "Resource ID must start with /subscriptions/" in error_msg
                    or "Resource ID must be for a Log Analytics workspace" in error_msg
                )
        ...
        collection_data = {
            "workspaces": [
                ...
                },
                {
                    ...
                    },  # Another empty - should be filtered out
                },
            ]
        }
